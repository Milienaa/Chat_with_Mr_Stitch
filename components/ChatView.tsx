...
import type { Message as MessageType, User, SimulationMessage } from '../types';
  ...
  return (
    <div className="flex flex-col flex-1 overflow-hidden">
          ...
          {messages.map(msg => (
           ...
           {messages.length === 0 && (
            <div className="text-center text-slate-500 pt-10">
              <p>Чат порожній.</p>
              <p className="text-sm">Скористайтесь інструментами тестування або оберіть користувача та напишіть перше повідомлення.</p>
            </div>
          )}
        </div>
      ...
      <div className="bg-white border-t border-slate-200">
        <SimulationControls 
          users={users}
          onSendScriptMessages={onSendScriptMessages}
          onGenerateDiscussion={onGenerateDiscussion}
          isGenerating={isGeneratingDiscussion}
